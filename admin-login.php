        ...
        <div class="login-container">
            <div class="login-content">
                ...
                <form action="admin-login.php" method="POST">
                    ...
                    >Not an Admin? Click <a href="login.php" style='text-decoration: none; color: rgb(53, 53, 255);' > here.</a></h6>
                    <br><br>
...
{ 
  ...
  $sql_query = "SELECT u.id FROM `adminaccount` u WHERE u.email = '$email' AND u.password = '$pass'";
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          ...
          {   
              ...
              $success = true;
              $_SESSION["adminid"] = $row["id"];//we use session method for the generated id of user who login to use it for recovery
          }
        }
      }
  if ($success == true)
